...
namespace XamlAnimatedGif
{
    internal class ImageAnimator : Animator
    {
        ...
        protected override RepeatBehavior GetSpecifiedRepeatBehavior() {return AnimationBehavior.GetRepeatBehavior(_image);}

        protected override object ErrorSource { get { return _image; } }
